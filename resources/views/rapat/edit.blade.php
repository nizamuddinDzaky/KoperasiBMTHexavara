    ...
    <div class="content">
        <div class="panel-group">
            <div class="panel panel-primary">
              <div class="panel-heading">Edit Data Rapat</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul" placeholder="Pilih Judul Rapat" value={{ $rapat->judul }} maxlength="10" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tanggal_berakhir" class="form-control" id="datepicker" placeholder="Tanggal Berakhir" value={{ $rapat->tanggal_berakhir }} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="deskripsi">{!! $rapat->description !!}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 {{ !$errors->has('file') ?: 'has-error' }}">
                            <div class="text-center">
                                <img style="margin: auto; width:500px;" class="pic" src="{{ asset('storage/public/rapat/' . $rapat->foto ) }}) }}"/>
                            </div>
                        </div>
                    </div>
