			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="card card-wizard" id="wizardCard">
						<form id="wizardForm" method="POST" action="{{route('teller.addidentitas')}}" enctype="multipart/form-data"">
							{{csrf_field()}}
											...
											<div class="col-md-10 col-md-offset-1">
												<div class="form-group">
													...
													<select name="pendidikan" class="form-control" selected="{{isset(json_decode(Auth::user()->detail,true)['pendidikan'])?json_decode(Auth::user()->detail,true)['pendidikan']:""}} required >
														...
														<option value="SMP">SMP/SLTP/MTS</option>
														<option value="SMA">SMA/SMK/SLTA/MAN</option>
														<option value="D1">D1/D3</option>
											...
											<div class="col-md-5 {{ !$errors->has('file') ?: 'has-error' }}">
												<div class="form-group">
													...
													<select name="rumah" class="form-control" selected="{{isset(json_decode(Auth::user()->detail,true)['rumah'])?json_decode(Auth::user()->detail,true)['rumah']:""}}" required>
														...
														<option value="KK">Kontrak</option>
														<option value="KS">Kos</option>
														<option value="MW">Menumpang wali</option>
													</select>
												</div>
											</div>
										</div>
					...
					<div class="ui card matthew">
						...
						<div class="content">
							...
							<div class="description">
								{{Auth::user()->nama}} is an art director living in New York.
							</div>
						</div>
