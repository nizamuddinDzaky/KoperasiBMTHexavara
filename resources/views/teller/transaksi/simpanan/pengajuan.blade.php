                                        ...
                                        @else
                                            @if(Auth::user()->tipe=="teller")
                                                {{--KONFIRMASI UNTUK TRANSAKSI--}}
                                                    <button type="button" id="konfirm" class="btn btn-social btn-info btn-fill" data-toggle="modal" data-target="#confirm{{str_replace(' ', '', $usr['jenis_pengajuan'])}}Modal" title="Konfirmasi Pengajuan"
                                                        data-id       = "{{$usr['id']}}"
