...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="head-filter">
                    <p class="filter-title">Periode Kegiatan</p>
                ...
                <div class="button-group right">
                    <div class="button-component-teller"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs teller" role="tablist">
        ...
        <div class="tab-content">
            ...
            @include('teller/transaksi/maal/kegiatan')
            </div>
            <div role="tabpanel" class="tab-pane" id="zis">
            @include('teller/transaksi/maal/zis')
            </div>
            <div role="tabpanel" class="tab-pane" id="wakaf">
            @include('teller/transaksi/maal/wakaf')
            </div>
        </div>
