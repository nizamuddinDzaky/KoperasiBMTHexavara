<div class="modal fade" id="donasiKegiatanWakaf" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="card card-wizard wizardCard">
            <form class="wizardForm" method="POST" action="{{route('donasiwakaf.umum')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-10 col-lg-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-left"  id="namaWakaf" name="namaWakaf" readonly="true">
                                    </div>
                                </div>
                            </div>
