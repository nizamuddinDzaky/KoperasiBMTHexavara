...
<div class="modal fade" id="pencairanWakafModal" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width: 80%">
        <div class="card card-wizard" id="wizardCardP">
            <form id="wizardFormP" method="POST" action="{{route('admin.wakaf.pencairan')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                <input type="hidden" id="id_kegiatan" name="idkegiatan">
                <input type="hidden" id="id_rekening" name="idrekening">
                <div class="header text-center">
                    <h3 class="title">Pencairan Donasi Kegiatan Wakaf</h3>
                    <p class="category">BMT MANDIRI UKHUWAH PERSADA</p>
                </div>

                <div class="content">
                    <ul class="nav">
                        <li><a href="#tab1p" data-toggle="tab" id="namaKegiatan">Data Donasi Wakaf</a></li>
                    </ul>
