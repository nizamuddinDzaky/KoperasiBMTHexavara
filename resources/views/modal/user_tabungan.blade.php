                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="idRekC" name="idRek" style="width: 100%;" required>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="jeniscls" name="jenis" style="width: 100%;" required>
                            ...
                            <div class="row" id="toHidecls">
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id=bankcls name="bank" style="width: 100%;" >
...
<div class="modal fade" id="kreditTabModal" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="card card-wizard" id="wizardCardKre">
            <form id="wizardFormKre" method="POST" @if(Auth::user()->tipe=="admin")action="{{route('admin.konfirmasi.kredit')}}" @elseif(Auth::user()->tipe=="teller")action="{{route('teller.tabungan.kredit')}}" @else action="{{route('anggota.kredit_tabungan')}}" @endif enctype="multipart/form-data">
                {{csrf_field()}}
                @if(Auth::user()->tipe!="anggota")
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="kredit" name="kredit" style="width: 100%;" required>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih jenis Transaksi-</option>
                                            <option value="0">Tunai</option>
                                            <option value="1">Transfer</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" class="currencyDecimal form-control text-right" id="krejumlah"  disabled>
{{--                                            <span class="input-group-addon">.00</span>--}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" @if(Auth::user()->tipe!=='anggota') class="currencyDecimal form-control text-right" @else class="currency form-control text-right"  @endif id="saldo_kre" name="jumlah" required="true">
{{--                                            <span class="input-group-addon">.00</span>--}}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="tab1TabDebv">
                            ...
                            <div class="row" id="toHideDebv">
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Transfer ke Rek. BANK <star>*</star></label>
                                        <select class="form-control" id=vbankdeb name="bank" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih Rekening BANK-</option>
                                            @foreach ($dropdown6 as $rekening)
                                                <option value="{{ $rekening->id }}"> [{{$rekening->id_rekening }}] {{ $rekening->nama_rekening }}</option>
                                            @endforeach
                        ...
                        <div class="tab-pane" id="tab1TabDeba">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="id_" class="control-label">Rekening Tabungan <star>*</star></label>
                                        <select class="form-control" id="aRekDeb" name="idRek" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected disabled value="">-Pilih Rekening Tabungan-</option>
                                            @foreach ($tab as $rekening)
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Jenis Transaksi <star>*</star></label>
                                        <select class="form-control" id="adebitdeb" name="debit" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih jenis Transaksi-</option>
                                            <option value="Tunai">Tunai</option>
                                            <option value="Transfer">Transfer</option>
                                        </select>
                            ...
                            <div class="row" id="toHideDeba">
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id=abankdeb name="bank" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih Rekening BANK-</option>
                                            @foreach ($dropdown6 as $rekening)
                                                <option value="{{ $rekening->id }}"> [{{$rekening->id_rekening }}] {{ $rekening->nama_rekening }}</option>
                                            @endforeach
                        ...
                        <div class="tab-pane" id="tab1TabKreC">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="id_" class="control-label">Pilih Rekening Tabungan <star>*</star></label>
                                        <select class="form-control" id="cRekKre" name="idRek" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected disabled value="">-Pilih Rekening Tabungan-</option>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Jenis Transaksi <star>*</star></label>
                                        <select class="form-control" id="ckredit" name="kredit" style="width: 100%;" disabled>
...
<div class="modal fade" id="debitTabModal" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="card card-wizard" id="wizardCardDeb">
            <form id="wizardFormDeb" method="POST" @if(Auth::user()->tipe=="admin")action="{{route('admin.konfirmasi.debit')}}" @elseif(Auth::user()->tipe=="teller")action="{{route('teller.tabungan.debit')}}" @else action="{{route('anggota.debit_tabungan')}}" @endif enctype="multipart/form-data">
                {{csrf_field()}}
                @if(Auth::user()->tipe!="anggota")
                    <input type="hidden" name="teller" value="teller">
                    <input type="hidden" id="jumlahCKA" name="jumlahCK">
                        ...
                        <div class="tab-pane" id="tab1TabDeb">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="id_" class="control-label">Pilih Rekening Tabungan <star>*</star></label>
                                        <select class="form-control" id="idRek" name="idRek" style="width: 100%;" required>
                                            <option class="bs-title-option" selected disabled value="">-Pilih Rekening Tabungan-</option>
                                            @if(Auth::user()->tipe=="anggota")
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Jenis Transaksi <star>*</star></label>
                                        <select class="form-control" id="debit" name="debit" style="width: 100%;" required>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih jenis Transaksi</option>
                                            <option value="0">Tunai</option>
                                            <option value="1">Transfer</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" @if(Auth::user()->tipe!=='anggota') class="currencyDecimal form-control text-right" @else class="currency form-control text-right"  @endif id="vjumlah" name="jumlah" required="true">
{{--                                            <span class="input-group-addon">.00</span>--}}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="tab1TabKrev">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Jenis Transaksi <star>*</star></label>
                                        <select class="form-control" id="vkredit" name="kredit" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih jenis Transaksi-</option>
                                            <option value="Tunai">Tunai</option>
                                            <option value="Transfer">Transfer</option>
                                        </select>
                        ...
                        <div class="tab-pane" id="tab1TabW">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Jenis Transaksi <star>*</star></label>
                                        <select class="form-control" id="jwajib" name="jenis" style="width: 100%;" required>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih jenis Transaksi-</option>
                                            <option value="0">Tunai</option>
                                            <option value="1">Transfer</option>
                                        </select>
                            ...
                            <div class="row" id="toHideWB">
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Transfer ke Rek. BANK <star>*</star></label>
                                        <select class="form-control" id="bankrek" name="bank" style="width: 100%;">
                                            <option class="bs-title-option" selected value="" disabled>-Pilih Rekening BANK-</option>
                                            @foreach ($dropdown6 as $rekening)
                                                <option value="{{ $rekening->id }}"> [{{$rekening->id_rekening }}] {{ $rekening->nama_rekening }}</option>
                                            @endforeach
                        ...
                        <div class="tab-pane" id="vtab1TabW">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Jenis Transaksi <star>*</star></label>
                                        <select class="form-control" id="vjwajib" name="jenis" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih jenis Transaksi-</option>
                                            <option value="0">Tunai</option>
                                            <option value="1">Transfer</option>
                                        </select>
                            ...
                            <div class="row" id="vtoHideWB">
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Transfer ke Rek. BANK <star>*</star></label>
                                        <select class="form-control" id="vbankrek" name="bank" style="width: 100%;" disabled>
                                            @foreach ($dropdown6 as $rekening)
                                                <option value="{{ $rekening->id }}"> [{{$rekening->id_rekening }}] {{ $rekening->nama_rekening }}</option>
                                            @endforeach
                                        </select>
...
<div class="modal fade" id="confirmDebModal" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="card card-wizard" id="wizardCardDebc">
            <form id="wizardFormDebc" method="POST" @if(Auth::user()->tipe=="admin")action="{{route('admin.konfirmasi.debit')}}" @elseif(Auth::user()->tipe=="teller")action="{{route('teller.konfirmasi.kredit')}}" @endif enctype="multipart/form-data">
                {{csrf_field()}}
                        ...
                        <div class="tab-pane" id="tab1TabC">
                            ...
                            <div class="row" id="toHideDebc" >
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="namaSim" class="control-label">Transfer ke Rek. BANK <star>*</star></label>
                                        <select class="form-control" id=cbankdeb name="bank" style="width: 100%;" disabled>
                                            <option class="bs-title-option" selected value="" disabled>-Pilih Rekening BANK-</option>
                                            @foreach ($dropdown6 as $rekening)
                                                <option value="{{ $rekening->id }}"> [{{$rekening->id_rekening }}] {{ $rekening->nama_rekening }}</option>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" @if(Auth::user()->tipe!=='anggota') class="currencyDecimal form-control text-right" @else class="currency form-control text-right"  @endif id="tjumlah" name="jumlah" required="true">
{{--                                            <span class="input-group-addon">.00</span>--}}
                                        </div>
                                    </div>
                                </div>
