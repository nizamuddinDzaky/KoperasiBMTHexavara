                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="header text-center">
                           <h4 class="title"><b>Pendapatan</b> </h4>
                            <p class="category">Laporan Pendapatan periode {{date("F Y")}}</p>
                                <br />
                        </div>
                        <div class="toolbar">
                            <!--        Here you can write extra buttons/actions for the toolbar              -->
                            <form action="{{route('periode.pendapatan')}}" method="post">
                                {{ csrf_field() }}
                                <div align="center">
                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            @endforeach
                                <tr>
                                    <td></td>
                                    <td class="text-center text-uppercase"><h5>Jumlah Pendapatan  </h5></td>
