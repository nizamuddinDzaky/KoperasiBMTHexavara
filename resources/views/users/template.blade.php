            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="ui card matthew">
                        <div class="image">
                            <img src="{{ URL::asset('bootstrap/assets/img/matthew.png') }}">
                        </div>
                        <div class="content">
                            <a class="header">Ghani</a>
                            <div>
                                <span class="date">Joined in 2013</span>
                            </div>
                            <div class="description">
                                Ghani is an art director living in New York.
                            </div>
                        </div>
                        <div class="extra content">
                            <a>
                                <i class="fab fa-twitter">22 Friends</i>
                            </a>
                        </div>
                    </div>
                </div>
