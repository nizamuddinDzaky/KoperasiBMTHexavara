                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="header text-center">
                            ...
                            <p class="category">Mudharabah Berjangka Nasabah <b>{{isset($data[0])?($data[0]['jenis_deposito']." [ID : ".$data[0]['id_deposito']."]"):""}}</b></p>
                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            @foreach ($data as $usr)
                                <tr>
                                    ...
                                    @else
                                        <td class="text-center text-uppercase">[{{ $usr->id_rek2}}] {{" ". $usr->dari_rekening }}</td>
                                    @endif
                                    @if(json_decode($usr->transaksi,true)['untuk_rekening']==null || json_decode($usr->transaksi,true)['untuk_rekening']=="Tunai" )
                                        <td class="text-center text-uppercase">Tunai</td>
                                    @else
                                        <td class="text-center text-uppercase">[{{ $usr->id_rek}}] {{" ". $usr->untuk_rekening }}</td>
                                    @endif
