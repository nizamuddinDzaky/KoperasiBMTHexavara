                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="header text-center">
                            ...
                            <p class="category">Tabungan Anggota <b>{{isset($data[0])?($data[0]['jenis_tabungan']." [ID : ".$data[0]['id_tabungan']."]"):""}}</b></p>
                            ...
                            @foreach ($data as $usr)
                                @if($usr->status !== "Setoran Awal")
                                    <tr>
                                        ...
                                        @if($usr->status == "Debit" || $usr->status == "Distribusi Pendapatan" || $usr->status == "Distribusi SHU" || (str_before($usr->status, " ") == "SIMPANAN" && json_decode($usr->transaksi)->jumlah > 0))
