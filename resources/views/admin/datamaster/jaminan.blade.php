    ...
    <div class="head">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h4 class="title">Datamaster Jaminan BMT</h4>
                ...
                <div class="button-group right">
                    <button class="btn btn-primary rounded right shadow-effect" data-toggle="modal" data-target="#addJamModal"><i class="fa fa-user-plus"></i> Tambah Master Jaminan</button>
                </div>
            </div>
        </div>
    </div>
