    ...
    <div class="head">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h4 class="title">Datamaster Pembagian SHU BMT</h4>
                ...
                <div class="button-group right">
                    <button class="btn btn-primary rounded right shadow-effect" data-toggle="modal" data-target="#addSHUModal"><i class="fa fa-user-plus"></i> Tambah SHU</button>
                    <button class="btn btn-danger rounded right shadow-effect" data-toggle="modal" data-target="#editSHUModal"><i class="fas fa-edit"></i> Edit Persentase SHU</button>
                </div>
            </div>
        </div>
    </div>
