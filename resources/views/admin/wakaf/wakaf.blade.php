                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="header text-center">
                            <h4 class="title"><b>Daftar Kegiatan Wakaf</b></h4>
                            <p class="category">Kegiatan Wakaf</p>
                            {{--<br />--}}
                        </div>
                        <div class="toolbar">
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-center">
                                        <form  method="post" @if(Auth::user()->tipe=="admin")action="{{route('admin.detail_transaksi.wakaf')}}" @else action="{{route('teller.detail_transaksi_wakaf')}}" @endif>
                                            ...
                                            @if(Auth::user()->tipe=="admin")
                                                <button type="button" class="btn btn-social btn-success btn-fill" data-toggle="modal" title="Pencairan Dana" data-target="#pencairanWakafModal"
                                                        data-id      = "{{$usr->id}}"
...
@section('extra_script')
    ...
    <script type="text/javascript">
        ...
        $('#pencairanWakafModal').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
