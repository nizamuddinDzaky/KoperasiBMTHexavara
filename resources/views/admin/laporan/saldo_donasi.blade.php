            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="head-noted right">
                    ...
                    <div class="button-group">
                        <button class="btn btn-primary rounded right shadow-effect" data-toggle="modal" data-target="#addMaalModal"><i class="fa fa-plus"></i> Buat Kegiatan Maal Baru</button>
                    </div>
                </div>
            </div>
        </div>
