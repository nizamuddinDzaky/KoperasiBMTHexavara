                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="header text-center">
                           <h4 class="title"><b>Laporan Aktiva</b> </h4>
                            <p class="category">Laporan Aktiva periode {{date("F Y")}}</p>
                                <br />
                        </div>
                        <div class="toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <form action="{{route('periode.aktiva')}}" method="post">
                                        {{ csrf_field() }}
                                        <div align="center">
                                ...
                                <tr>
                                    ...
                                    @if($usr->tipe_rekening =="detail")
                                        @if(number_format(floatval($usr->saldo),2)<0)
                                            <td class="text-right">Rp ({{ number_format( abs(floatval($usr->saldo)),2 )}})</td>
                                        @else
