                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="header text-center">
                            <h3 class="title"><b>Laporan Saldo Kas</b></h3>
                        ...
                        <table id="bootstrap-table" class="table table">
                            ...
                            <th data-field="country" data-sortable="true" class="text-center">Nama Kas</th>
                            <th data-field="city3" class="text-center">Saldo</th>
                            </thead>
                            <tbody>
                            <tr>
                                <td class="active text-center"></td>
                                <td class="active text-right"><b>Saldo Periode {{date('F Y')}}</b> </td>
                                <td class="active text-right">20,000,000</td>
                                <td class="active"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="active text-center"></td>
                                <td class="active text-right"><b>Jumlah</b> </td>
                                <td class="active text-right">30,000,000</td>
                                <td class="active"></td>
                            </tr>
                            <tr>
                                <td class="success text-center"></td>
                                <td class="success text-right"><b> Saldo </b></td>
                                <td class="success text-right">50,000,000</td>
                                <td class="success"></td>
                            </tr>
                            </tbody>
                        </table>
