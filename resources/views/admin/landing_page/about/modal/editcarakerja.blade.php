<div class="modal fade" id="editCaraKerjaModal" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="card card-wizard wizardCard">
            <form class="wizardForm" method="POST" action="{{route('admin.landingpage.carakerja.update')}}"  enctype="multipart/form-data">
                {{csrf_field()}}

                <div class="header text-center">
                    <h3 class="title">Edit Cara Kerja </h3>
                    <p class="category">BMT MANDIRI UKHUWAH PERSADA</p>
                </div>

                <div class="content">
                    <ul class="nav">
                        <li><a href="#tabEditCaraKerja" data-toggle="tab">Cara Kerja</a></li>
                    </ul>

                    <div class="tab-content">
                        <div class="tab-pane" id="tabEditCaraKerja">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-10 col-lg-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-left" maxlength="39" name="keterangan" id="keterangan_carakerja_edit" required>
                                        <input type="hidden" id="id_carakerja_edit" name="id_carakerja">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
