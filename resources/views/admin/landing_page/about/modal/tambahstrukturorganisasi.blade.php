<div class="modal fade" id="tambahStrukturOrganisasiModal" role="dialog" aria-labelledby="addOrgLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="card card-wizard wizardCard">
            <form class="wizardForm" method="POST" action="{{route('admin.landingpage.strukturorganisasi.insert')}}"  enctype="multipart/form-data">
                {{csrf_field()}}

                <div class="header text-center">
                    <h3 class="title">Tambah Anggota Struktur Organisasi </h3>
                    <p class="category">BMT MANDIRI UKHUWAH PERSADA</p>
                </div>

                <div class="content">
                    <ul class="nav">
                        <li><a href="#tabTambahStrukturOrganisasi" data-toggle="tab">Struktur Organisasi</a></li>
                    </ul>

                    <div class="tab-content">
                        <div class="tab-pane" id="tabTambahStrukturOrganisasi">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-10 col-lg-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-left" name="jabatan">
                                    </div>
                                </div>
                            </div>
