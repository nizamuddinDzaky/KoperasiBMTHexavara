                    ...
                    <div class="card card-wizard " style="">
                        <form id="wizardForm" method="" action="#">
                            <div class="header text-center">
                                ...
                                <p class="category">Transfer antar Rekening BMT </p>
                            </div>

                            <div class="footer">
                                <button type="button" class="btn btn-fill btn-block btn-info center-block" data-toggle="modal" data-target="#transferRekModal">Transfer Rekening BMT</button>
                ...
                <div class="col-md-4">
                    <div class="card card-wizard " style="">
                        <form id="wizardForm" method="" action="#">
                            <div class="header text-center">
                                <span class="fa-stack fa-3x">
                                    <i class="fas fa-square fa-stack-2x" style="color:darkmagenta"></i>
                                    <i class="fas fa-credit-card fa-stack-1x fa-inverse"></i>
                                </span>
                                <h3 class="title">Pengeluaran/Pemasukan</h3>
                                <p class="category">Transfer ke Rekening BMT </p>
                            </div>

                            <div class="footer">
                                <button type="button" class="btn btn-fill btn-block btn-info center-block" data-toggle="modal" data-target="#jurnalLainRekModal">Transfer Pengeluaran/Pemasukan</button>
                                <div class="clearfix"></div>
                            </div>
                        </form>
                    ...
                    <div class="card card-wizard " style="">
                        <form id="wizardForm" method="" action="#">
                            <div class="header text-center">
                                ...
                                <h3 class="title">Simpanan Wajib Pokok</h3>
                                <p class="category">Upgrade Simpanan Wajib Pokok </p>
                            </div>

                            <div class="footer">
                                <button type="button" class="btn btn-fill btn-block btn-info center-block" data-toggle="modal" data-target="#wapokRekModal">Upgrade Simpanan</button>
                                <div class="clearfix"></div>
                            </div>
                        </form>
