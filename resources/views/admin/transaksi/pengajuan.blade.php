                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            @foreach ($data as $usr)
                                <tr>
                                    ...
                                    <td class="text-uppercase text-center">{{ $usr['kategori'] }}</td>
                                    <td class="text-left">{{ $usr['jenis_pengajuan']   }}</td>
                                    @if(str_before($usr['kategori'],' ')=="Debit" || str_before($usr['kategori'],' ')=="Kredit"|| str_before($usr['kategori'],' ')=="Angsuran"|| str_before($usr['kategori'],' ')=="Donasi")
                                    ...
                                    <td class="td-actions text-center">
                                        <div class="row">
                                        @if(str_before($usr['kategori'],' ')=="Debit" || str_before($usr['kategori'],' ')=="Kredit"|| str_before($usr['kategori'],' ')=="Angsuran"|| str_before($usr['kategori'],' ')=="Pencairan"|| str_before($usr['kategori'],' ')=="Donasi")
